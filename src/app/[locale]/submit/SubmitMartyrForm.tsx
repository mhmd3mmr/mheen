...
export function SubmitMartyrForm({ onError }: Props) {
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1">
          <label className="text-sm font-medium text-foreground">{t("martyrName")} *</label>
          <input
            name="name_ar"
            required
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-foreground">{t("martyrNameEn")}</label>
          <input
            name="name_en"
            className="w-full rounded-lg border border-primary/20 bg-background px-3 py-2.5 text-sm text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
          />
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-foreground">{t("bioAr")}</label>
        <textarea
          name="bio_ar"
          rows={3}
          className="w-full rounded-lg border border-primary/20 bg-background px-3 py-2.5 text-sm text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-foreground">{t("bioEn")}</label>
        <textarea
          name="bio_en"
          rows={3}
          className="w-full rounded-lg border border-primary/20 bg-background px-3 py-2.5 text-sm text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
